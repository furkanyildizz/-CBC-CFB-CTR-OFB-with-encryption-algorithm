...
def ctr(algoritmaIsmi,plaintext,key,ivboyut):
    ivboyut=ivboyut/2
    print("")
    print("####################CTR#####################")
...
#############################################"AES"############################################################
    if algoritmaIsmi=="AES":
        ...
        for i in hexparcalanmisPlain:
            ...
            vi = deneme.AES.encrypt(iv+sayac)
            cipher=vi ^ i
            cipherlar.append(cipher)
            print("XORLANMIS SIRASI ILE CIKAN CIPHERLAR: ","%x" % cipher)
            sayac=sayac+1
        sayac=0x0
        #DECRYPT
        print("")
        ...
        for i in cipherlar:
            ...
            deneme=AES
            deneme.AES = AES(key)
            vi = deneme.AES.encrypt(ivorj+sayac)
            plain=vi ^ i
...
######################################################CLEFIA################################
    ...
    if algoritmaIsmi=="CLEFIA":
        ...
        for i in hexparcalanmisPlain:
            ...
            vi = sifreleClefia(key,"SIZE_128",iv+sayac)
            cipher=vi ^ i
            cipherlar.append(cipher)
            print("XORLANMIS SIRASI ILE CIKAN CIPHERLAR: ","%x" % cipher)
            sayac=sayac+1
        ...
        for i in cipherlar:
            ...
            vi = sifreleClefia(key,"SIZE_128",ivorj+sayac)
            plain=vi ^ i
            print("CIPHER ILE XORLARMIS PLAIN","%x" % plain)
            plainler.append(plain)
            sayac=sayac+1
...
##################################GOST##################################
    if algoritmaIsmi=="GOST":
        ...
        for i in hexparcalanmisPlain:
            ...
            vi = gostdeneme.encrypt(iv+sayac)
            cipher=vi ^ i
            cipherlar.append(cipher)
            print("XORLANMIS SIRASI ILE CIKAN CIPHERLAR: ","%x" % cipher)
            sayac=sayac+1
        ...
        for i in cipherlar:
            ...
            vi = gostdeneme.encrypt(ivorj+sayac)
            plain=vi ^ i
            print("CIPHER ILE XORLARMIS PLAIN","%x" % plain)
            plainler.append(plain)
            sayac=sayac+1
...
######################################################KATAN#################################
    if algoritmaIsmi=="KATAN":
        ...
        for i in cipherlar:
            ...
            vi = katandeneme.enc(ivorj+sayac)
            plain=vi ^ i
            print("CIPHER ILE XORLARMIS PLAIN","%x" % plain)
            plainler.append(plain)
            sayac=sayac+1
...
#############################################KTANTAN###############################################
    ...
    if algoritmaIsmi=="KTANTAN":
        ...
        for i in cipherlar:
            ...
            vi = ktantandeneme.enc(ivorj+sayac)
            plain=vi ^ i
            print("CIPHER ILE XORLARMIS PLAIN","%x" % plain)
            plainler.append(plain)
            sayac=sayac+1
