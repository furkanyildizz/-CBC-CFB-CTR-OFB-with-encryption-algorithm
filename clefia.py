...
def encrypt(ptext):
    ...
    t32[1] ^= wk[2]
    t32[3] ^= wk[3]
    #print("SIFRELENMIS HALI")
    #print("%x" % _32To128(t32))
    return _32To128(t32)
...
def decrypt(ctext):
    ...
    t32[1] ^= wk[0]
    t32[3] ^= wk[1]
    #print("DESIFRELENMIS HALI clefia")
    #print("%x" % _32To128(t32))
    return _32To128(t32)

def sifreleClefia(key, keySize, plaintext, nIter = 1000):
    print("")
    print("KEY")
    print("%x" % key)
    print("CLEFIAYA GELEN SIFRELENECEK PLAINTEXT")
    print("%x" % plaintext)
    testSuccess = True
    setKey(key, keySize)
    ks = ksTable[keySize] * 8
    ctext = encrypt(plaintext)
    print("CLEFIADA SIFRELENMIS HALI")
    print("%x" % ctext)
...
def desifreleClefia(key, keySize, ciphertext, nIter = 1000):
    print("")
    print("CLEFIAYA GELEN COZULECEK SIFRE")
    print("%x" % ciphertext)
    testSuccess = True
    setKey(key, keySize)
    ks = ksTable[keySize] * 8
    ptext = decrypt(ciphertext)
    print("CLEFIADA COZULMUS HALI")
    print("%x" % ptext)
...
def checkTestVector(key, keySize, plaintext, ciphertext, nIter = 1000):
    print("KEY")
    print("%x" % key)
    print("ILK GELEN PLAINTEXT")
    print("%x" % plaintext)
    print("ILK GELEN CIPHERTEXT")
    print("%x" % ciphertext)
    testSuccess = True
    setKey(key, keySize)
    ks = ksTable[keySize] * 8
...
ptext = 0x000102030405060708090a0b0c0d0e0f
    ...
    # Test vector for 128-bit key
key1 = 0x51655468576D5A7133743677397A2443
...
ctext2 = 0xe2482f649f028dc480dda184fde181ad
    ...
    # Test vector for 256-bit key
key3 = 0x77217A25432646294A404E635266556A586E3272357538782F413F4428472B4B
ctext3 = 0xa1397814289de80c10da46d1fa48b38a
