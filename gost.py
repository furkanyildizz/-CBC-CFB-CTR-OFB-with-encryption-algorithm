...
class GOST:
    ...
    def encrypt(self, plaintext):
        print("")
        print("GOSTDA SIFRELENECEK PLAINTEXT")
        print("%x" % plaintext)
        ...
        yazdirma=(text_left << 32) | text_right
        #print(hex(yazdirma))
        print("GOSTDA SIFRELENMIS HALI")
        print("%x" % yazdirma)
        return (text_left << 32) | text_right

    def decrypt(self, ciphertext):
        print("")
        print("GOSTDA COZULECEK SIFRE")
        print("%x" % ciphertext)
